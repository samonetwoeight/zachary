		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4 scroll ps ps--active-y" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="height: 534px; overflow: hidden;">
							<!--begin::Menu Nav-->
							<ul class="menu-nav">
								<li class="menu-item <?php if(current_url() == base_url() || current_url() == base_url('Dashboard')){ echo 'menu-item-active'; } ?>" aria-haspopup="true">
								...
								<li class="menu-item <?php if(current_url() == base_url('User')){ echo 'menu-item-active'; } ?>" aria-haspopup="true">
								...
								<li class="menu-item <?php if(current_url() == base_url('Schedular')){ echo 'menu-item-active'; } ?>" aria-haspopup="true">
									<a href="<?php echo base_url('Schedular?date='.date('Y-m-d').''); ?>" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Design/Layers.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							...
							<!--end::Menu Nav-->
						<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 534px; right: 4px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 247px;"></div></div></div>
						<!--end::Menu Container-->
					</div>
					<!--end::Aside Menu-->
				</div>
				...
				<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					<!--begin::Header-->
					<div id="kt_header" class="header header-fixed" style="background-color:#EEF0F8;">
						<!--begin::Container-->
							...
							<div class="topbar">
								...
								<div class="topbar-item">
									<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										...
										<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">Tester</span>
						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									...
									<!--end::Page Title-->
									<!--begin::Actions-->
									<?php if(current_url() == base_url('User') || current_url() == base_url('Schedular')){ ?>
									<div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
									<a href="<?php echo $addlink; ?>" class="btn btn-light-warning font-weight-bolder btn-sm">Add New</a>
									<?php } ?>
									<!--end::Actions-->
								</div>
								<!--end::Info-->
							...
							<div class="offcanvas-content pr-5 mr-n5 scroll ps ps--active-y" style="height: 519px; overflow: hidden;">
								...
								<div class="d-flex align-items-center mt-5">
									...
									<div class="d-flex flex-column">
										<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">Tester-San</a>
										<div class="text-muted mt-1">Application Developer</div>
										<div class="navi mt-2">
											<a href="<?php echo base_url('Logout'); ?>" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
										</div>
									</div>
								</div>
								<!--end::Header-->
